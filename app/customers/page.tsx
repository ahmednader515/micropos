...
const customersButtons = [
  { label: 'اضافة عميل جديد', icon: '➕', onClick: () => alert('اضافة عميل جديد') },
  { label: 'الارصدة الافتتاحية و المبالغ النقدية للعملاء', icon: '💵', onClick: () => alert('الارصدة الافتتاحية و المبالغ النقدية للعملاء') },
  { label: 'ذمم العملاء - المبالغ المتبقية عند العملاء من الفواتير', icon: '🧾', onClick: () => alert('ذمم العملاء - المبالغ المتبقية عند العملاء من الفواتير') },
  { label: 'ذمم العملاء - تقرير', icon: '📄', onClick: () => alert('ذمم العملاء - تقرير') },
  { label: 'العملاء المتبقي لهم ارصدة - تقرير', icon: '📊', onClick: () => alert('العملاء المتبقي لهم ارصدة - تقرير') },
  { label: 'فحص ارصدة العملاء', icon: '🔍', onClick: () => alert('فحص ارصدة العملاء') },
  { label: 'عرض  العملاء', icon: '👥', onClick: () => alert('عرض  العملاء') },
];
