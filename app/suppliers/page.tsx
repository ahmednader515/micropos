...
const suppliersButtons = [
  { label: 'اضافة مورد جديد', icon: '➕', onClick: () => alert('اضافة مورد جديد') },
  { label: 'الأرصدة الافتتاحيه و المبالغ النقدية للموردين', icon: '💵', onClick: () => alert('الأرصدة الافتتاحيه و المبالغ النقدية للموردين') },
  { label: 'المبالغ المتبقية للموردين من الفواتير', icon: '🧾', onClick: () => alert('المبالغ المتبقية للموردين من الفواتير') },
  { label: 'المبالغ المتبقية للموردين - تقرير', icon: '📄', onClick: () => alert('المبالغ المتبقية للموردين - تقرير') },
  { label: 'الموردين المتبقي عندهم ارصدة - تقرير', icon: '📊', onClick: () => alert('الموردين المتبقي عندهم ارصدة - تقرير') },
  { label: 'فحص ارصدة الموردين', icon: '🔍', onClick: () => alert('فحص ارصدة الموردين') },
  { label: 'عرض الموردين', icon: '🏢', onClick: () => alert('عرض الموردين') },
];
